...
public:
    Compressor();
	virtual unsigned char* encode(unsigned char *p_rawData, int p_sizeOfRawData, int p_sizeCodeTable, int p_sizeOfOutput) = 0;
	virtual unsigned char* decode(unsigned char *p_compData, int p_sizeOfCompData, unsigned char *p_codeTable, int p_sizeOfCodeTable, int p_sizeOfOutput) = 0;
