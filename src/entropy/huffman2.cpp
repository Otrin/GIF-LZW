...
unsigned char* Huffman2::encode(unsigned char *p_rawData, int p_sizeOfRawData, int p_sizeCodeTable){
...
//    for (int i = 0; i < m_currentSizeOfNodeArray+1; ++i) {
//        cout << m_nodes[i].getValue() << " => " << m_nodes[i].getFrequenzy() << endl;
//    }
...
//        cout << temp->getLeft().getFrequenzy() << endl;
//        cout << "3\n";
//        for (int i = 0; i < m_currentSizeOfNodeArray+1; ++i) {
//            cout << m_nodes[i].getValue() << " => " << m_nodes[i].getFrequenzy() << endl;
//        }
...
unsigned char* Huffman2::decode(unsigned char *p_compData, int p_sizeOfCompData, unsigned char *p_codeTable, int p_sizeOfCodeTable){
    if(p_sizeOfCompData == 0 || compData== NULL){
        throw "no Data!";
    }
    return NULL;
}

void Huffman2::insert(Node *node){
...
void Huffman2::setUpCodeMap(Node *temp, string code){
